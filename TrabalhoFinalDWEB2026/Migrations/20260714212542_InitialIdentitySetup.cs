    ...
    public partial class InitialIdentitySetup : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    NumeroUtente = table.Column<string>(type: "nvarchar(9)", maxLength: 9, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Forma = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoutorId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    FarmaceutaId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Receitas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Receitas_AspNetUsers_DoutorId",
                        column: x => x.DoutorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.FarmaceutaId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Receitas_AspNetUsers_UtenteId",
                        column: x => x.UtenteId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_NumeroUtente",
                table: "AspNetUsers",
                column: "NumeroUtente",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Receitas_DoutorId",
                table: "Receitas",
                column: "DoutorId");

            migrationBuilder.CreateIndex(
                name: "IX_Receitas_FarmaceutaId",
                table: "Receitas",
                column: "FarmaceutaId");

            migrationBuilder.CreateIndex(
                name: "IX_Receitas_UtenteId",
                table: "Receitas",
                column: "UtenteId");
        }
